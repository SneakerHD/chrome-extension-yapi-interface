/**
 * @description: json转ts interface 代码来源：https://github.com/llf137224350/json-to-ts-interface/edit/main/libs/interface_definition.js
 * @return {*}
 */
 ...
 * @returns {*} 结果
 */
function interfaceDefinition(res, options = {}) {
  // 合并全局配置
